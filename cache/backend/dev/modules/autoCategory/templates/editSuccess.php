...
<div id="sf_admin_container">
  <h1><?php echo __('Editing Category "%%company%% is looking for a %%position%%', array('%%company%%' => $JobeetCategory->getCompany(), '%%position%%' => $JobeetCategory->getPosition()), 'messages') ?></h1>
